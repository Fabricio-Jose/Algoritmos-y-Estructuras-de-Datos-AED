...
public:
    void setVideoInfo(string title, string star, string star2, string producer, string director, string productionCo, int setInStock);
...
void videoType::printInfo() const
{
    ...
    cout << "Producction Company: " << movieProductionCo << endl;
